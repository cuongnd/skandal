            ...
            <div class="col-md-4">
                <div class="domtab" style="height: 196px; width:270px;">
                    ...
                    <div style="padding:0; margin:-5px -8px;">
                        ...
                        <img src="img/portfolio/hanoi_200x145.jpg" width="100%" height="190">
                    </div>
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul style="float: left">
                            <li style=" width: 110px; float: left"><h4 style="margin: 0; padding: 0; color: #8d8a8a">$2000</h4>
                            </li>
                    ...
                    <div class="col-md-6">
                        <h6>
                            <small style="color:#990000; font-size: 11px; padding-left:90px">VIETNAM, LAOS, THAILAND</small>
                        </h6>
                    ...
                    <div class="col-md-12">
                        <ul style="margin:0; padding:0; border-top: 2px solid #e0e3e7;"><h6
                            ...
                            <li style=" float: right">
                                 <a style="float: right; margin: 0 10px 0 0;" href="<?php echo JUri::root().'index.php?option=com_tour&view=tourdetail' ?>">
