...
$document->addStyleSheet('modules/mod_list_tour/assets/css/domtab.css');

?>


<div class="row">
    <ul style="border: 1px solid #cccccc; margin:10px 20px 20px 0; padding: 0; background: #cccccc; height: 35px">
        <li style="background:url(img/common/bg_124x51.png) 0 -6px no-repeat; height: 51px">
            <h5 style="color: #FFFFFF; margin: 0; padding: 7px 15px">Top Tours</h5>
        </li>
    </ul>
</div>
<?php
$i = 0;
foreach ($listtour as $list){
    ?>
            ...
            <div class="col-md-12">
                <ul style="margin:0; padding:0; border-top: 2px solid #e0e3e7;"><h6
                    ...
                    <li style=" float: right">
                        <!--<a href="<?php /*$list->link;*/?>"><button class="btn btn-danger btn-xs">VIEW DETAILS &nbsp;<i class="fa fa-play"></i></button></a>-->
                        <a style="float: right; margin: 0 10px 0 0;" href="<?php echo $list->link ?>">
...
<?php  $i=$i+2;}?>
<script src="modules/mod_list_tour/assets/js/domtab.js"></script>