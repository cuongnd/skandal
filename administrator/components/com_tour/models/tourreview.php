...
class TourModelTourreview extends JModelAdmin
{

    public function getTable($type = 'tourreviews', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.tourreview', 'tourreviews', array('control' => 'jform', 'load_data' => $loadData));
