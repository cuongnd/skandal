...
class TourModelImageslider extends JModelAdmin
{

    public function getTable($type = 'imageslider', $prefix = 'TourTable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_tour.imageslider', 'imageslider', array('control' => 'jform', 'load_data' => $loadData));
