        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="title">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_HEADING_NAME', 'a.name', $listDirn, $listOrder);
                        ?>
                    </th>
                    <th width="10%" class="nowrap hidden-phone">
                        <?php echo JHtml::_('grid.sort', 'COM_TOUR_HEADING_CODE', 'a.code', $listDirn, $listOrder); ?>
                    </th>
                    <th width="15%">
                        <?php
                    ...
                    <th width="15%">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_FILED_PRICE', 'a.price', $listDirn, $listOrder);
                        ?>
                    </th>
				...
				<i class="icon-menu"></i>
                        ...
                        <td>
                            <a href="<?php echo JUri::base(); ?>index.php?option=com_tour&view=galleries&type=tour&tour_id=<?php echo $item->id; ?>"><input
                                    type="button" class="btn" value="List" style="font-weight: bold; font-size: 12px;"/></a>
                            <a href="<?php echo JUri::base(); ?>index.php?option=com_tour&view=gallery&type=tour&layout=edit&tour_id=<?php echo $item->id; ?>"><input
                                    type="button" class="btn" value="Add" style="font-weight: bold; font-size: 12px;"/></a>
                        </td>
                        <td>
                            <a href="<?php echo JUri::base(); ?>index.php?option=com_tour&view=tourtariffs&idtour=<?php echo $item->id; ?>">
                                <input type="button" class="btn" value="List" style="font-weight: bold; font-size: 12px;"/>
                            </a>
                            <a href="<?php echo JUri::base(); ?>index.php?option=com_tour&view=tourtariff&layout=edit&idtour=<?php echo $item->id; ?>">
                                <input type="button" class="btn" value="Add" style="font-weight: bold; font-size: 12px;"/></a>
                        </td>
