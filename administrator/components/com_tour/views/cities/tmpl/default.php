        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
				...
				<i class="icon-menu"></i>
                        ...
                        <td>
                            <a href="<?php echo JUri::base(); ?>index.php?option=com_tour&view=galleries&type=city&city_id=<?php echo $item->id; ?>"><input
                                    type="button" class="btn" value="List" style="font-weight: bold; font-size: 12px;"/></a>
                            <a href="<?php echo JUri::base(); ?>index.php?option=com_tour&view=gallery&type=city&layout=edit&city_id=<?php echo $item->id; ?>"><input
