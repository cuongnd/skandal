        ...
        <div id="j-main-container">
            ...
            <table class="table table-striped" id="tourList">
                ...
                <tr>
                    ...
                    <th class="name_client">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURREVIEWS_FILED_NAMECLIENT', 'a.name_client', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="email">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURREVIEWS_FILED_EMAIL', 'a.email', $listDirn, $listOrder);
                        ?>
                    </th>

                    <th class="image" width="5%">
                        <?php
                        echo JHtml::_('grid.sort', 'COM_TOUR_VIEW_TOURREVIEWS_FILED_STATE', 'a.state', $listDirn, $listOrder);
                        ?>
                    </th>
				...
				<i class="icon-menu"></i>
                        ...
                        <td class="nowrap has-context"><a
                                ...
                                <?php echo $this->escape($item->name_client); ?></a></td>
                        <td>
                        ...
                        <td class="center">
                            ...
                            <?php echo JHtml::_('jgrid.published', $item->state, $i,
                                'tourreviews.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                        </td>
                        <td class="center hidden-phone">
