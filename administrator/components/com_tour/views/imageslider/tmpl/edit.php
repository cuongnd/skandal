...
?>
<form
    action="<?php echo JRoute::_('index.php?option=com_tour&&view=imageslider&layout=edit&id='.(int) $this->item->id); ?>"
        ...
        <div class="span10 form-horizontal">
            <fieldset>
                ...
                <?php echo JHtml::_ ( 'bootstrap.addPanel', 'myTab', 'details', empty ( $this->item->id ) ? JText::_( 'COM_FOLIO_NEW_FOLIO', true ) : JText::sprintf ( 'COM_FOLIO_EDIT_FOLIO', $this->item->id, true ) );?>
                 ...
                 <?php echo $this->form->renderField('link_detail'); ?>
                 <?php echo $this->form->renderField('type_slider'); ?>
